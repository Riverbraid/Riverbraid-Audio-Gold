...
Riverbraid-Audio-Gold is a canonical Gold module surface within Riverbraid.

This repository represents the Audio domain inside the current Evaluation Kit registry. It supports audio surface verification material as part of the public Riverbraid verification constellation while Riverbraid-Core remains the normative source for protocol semantics.
